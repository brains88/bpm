...
class PropertiesController extends Controller
{
    ...
    {
        return view('properties.index')->with(['propertyCategories' => Category::where(['type' => 'property'])->get(), 'allProperties' => Property::where('status', '!=', 'sold off')->paginate(15), 'soldProperties' => Property::where(['status' => 'sold off'])->paginate(3)]);
    }
    ...
    public function category($category = 'lands')
    {
        ...
        return view('properties.category')->with(['categoryProperties' => $categoryProperties, 'propertyCategories' => Category::where(['type' => 'property'])->get(), 'soldProperties' => Property::where(['status' => 'sold off'])->paginate(3), 'name' => $category]);
    }
    ...
    public function country($country = 'usa')
    {
        ...
        return view('properties.country')->with(['countryProperties' => $countryProperties, 'propertyCategories' => Category::where(['type' => 'property'])->get(), 'soldProperties' => Property::where(['status' => 'sold off'])->paginate(3), 'country' => $country]);
    }
