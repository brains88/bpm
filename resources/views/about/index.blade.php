			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12 col-lg-10">
						<h1 class="text-main-green font-weight-bolder">About <span class="text-white">Us</span></h1>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mb-4">
						<h1 class="font-weight-bolder text-main-dark">Our <span class="text-main-green">Core</span> Values</h1>
				...
				<div class="row">
					<div class="col-12 col-md-6 col-lg-4 mb-4">
						<div class="bg-main-green text-center mb-4 rounded-circle" style="width: 70px; height: 70px; line-height: 70px;">
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4">
						<div class="bg-main-green text-center mb-4 rounded-circle core-values-icons" style="width: 70px; height: 70px; line-height: 70px;">
