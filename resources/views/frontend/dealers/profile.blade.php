@include('layouts.header')
    @include('frontend.layouts.navbar')
       	<section class="position-relative" style="padding: 140px 0;">
			<div class="container-fluid" style="margin-right: 40px !important;">
				@if(empty($profile))
					<div class="alert alert-info">Dealer profile not found</div>
				@else
					<div class="row">
							...
							<div class="mb-4 p-3 icon-raduis bg-white shadow-sm text-center">
								<div class="w-auto rounded-pill border">
									<div class="rounded" style="width: 80px; height: 80px;">
										<img src="{{ empty($profile->image) ? '/images/profiles/girl.jpg' : $profile->image }}" class="img-fluid mx-auto rounded ">
									</div>
								</div>
							</div>
							<div class="mb-4">
