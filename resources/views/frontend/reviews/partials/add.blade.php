    ...
    <div class="modal-dialog modal-dialog-centered modal-lg rounded" role="document">
        <div class="modal-content border-0">
            <form method="post" action="javascript:;" class="add-review-form" data-action="{{ route('review.add', ['profileid' => $profile->id]) }}" autocomplete="off">
                <div class="d-flex justify-content-between bg-main-ash rounded p-3">
                    <div class="text-main-dark mb-0">Review {{ ucwords($profile->user->name) }}</div>
                ...
                <div class="modal-body p-4">
                    <div class="form-group mb-4">
                        <label class="text-main-dark">Review (Maximum of 500 words.)</label>
                        <textarea class="form-control review" name="review" placeholder="Enter your review here" rows="8"></textarea>
