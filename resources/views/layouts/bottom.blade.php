		...
		<div class="container">
			<div class="row border-bottom-dark-500 pb-5 mb-5">
				<div class="col-12 col-md-4 col-lg-3 mb-4">
					<h4 class="text-main-green mb-4">Global Properties</h4>
				...
				<div class="col-12 col-md-4 col-lg-3 mb-4">
					<h4 class="text-main-green mb-4">About Us</h4>
				...
				<div class="col-12 col-md-4 col-lg-3 mb-4">
					<h4 class="text-main-green mb-4">Our Services</h4>
				...
				<div class="col-12 col-md-4 col-lg-3">
					<h4 class="text-main-green mb-4">Our Community</h4>
			...
			<div class="row">
				<div class="col-12 col-md-5 col-lg-4 mb-4">
					<div class="">
						<h4 class="text-main-green mb-4">Our Newsletter</h4>
