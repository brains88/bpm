<form action="javascript:;" method="post" class="property-search-form" data-action="{{ route('signup.corporate') }}" autocomplete="off">
    <div class="form-row">
        <div class="form-group col-12">
            <label class="text-main-green">Search Keyword</label>
     ...
     <div class="form-row">
     	<div class="form-group col-md-6">
            <label class="text-main-green">Property Category</label>
        ...
        <div class="form-group col-md-6">
            <label class="text-main-green">Property Location</label>
            <select class="form-control custom-select">
    ...
    <div class="form-row">
        <div class="form-group col-12 col-md-6">
            <label class="text-main-green">Minimum Price</label>
        ...
        <div class="form-group col-12 col-md-6">
            <label class="text-main-green">Miximum Price</label>
    ...
    <div class="mb-4">
        <label class="text-main-green">Additional Information</label>
        <textarea class="form-control additional" rows="4" placeholder="Enter any other information"></textarea>
    </div>
    <button type="submit" class="btn btn-lg bg-main-green mt-2 btn-block text-white property-search-button mb-4">
